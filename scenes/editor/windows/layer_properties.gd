...
func load_base_properties():
	...
	parallax.load_property(editor, get_property_value("parallax_distance"), [
		"parallax_distance",
		TYPE_REAL,
		PropertyInfo.new(parallax.hint_tooltip, 1, -ParallaxScroll.MAX_DISTANCE, ParallaxScroll.MAX_DISTANCE)
	])
	...
	enabled_missions.visible = not layer_data.layer_metadata.is_origin
	...
	min_shines.visible = not layer_data.layer_metadata.is_origin
	...
	max_shines.visible = not layer_data.layer_metadata.is_origin
