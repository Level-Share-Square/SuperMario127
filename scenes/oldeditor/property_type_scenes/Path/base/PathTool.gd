...
var path_node = preload("res://scenes/oldeditor/property_type_scenes/Path/base/PathNode.tscn")
var line_node = preload("res://scenes/oldeditor/property_type_scenes/Path/base/Line.tscn")
