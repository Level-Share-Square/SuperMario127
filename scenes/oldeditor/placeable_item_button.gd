...
func item_changed():
	...
	CurrentLevelData.level_data.layout_ids[box_index] = item.name
	CurrentLevelData.level_data.layout_palettes[box_index] = item.palette_index
	...
	if editor.placeable_items_button_container != null:
		for i in editor.placeable_items_button_container.get_children():
			CurrentLevelData.level_data.layout_ids[i.box_index] = i.item.name
			CurrentLevelData.level_data.layout_palettes[i.box_index] = i.item.palette_index
