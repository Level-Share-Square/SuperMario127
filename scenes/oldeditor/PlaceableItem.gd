...
#func on_place(position: Vector2, level_data: LevelDataOld, level_area: AreaDataOld):
...
#	return true
#
#func on_erase(position: Vector2, level_data: LevelDataOld, level_area: AreaDataOld):
