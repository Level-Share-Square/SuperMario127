...
func update_buttons(path: String = ""):
	...
	var is_campaign = list_handler.is_campaign
	...
	$FolderSettings.visible = not is_root_folder and not is_dev_folder and not is_campaign
	$CampaignSettings.visible = is_campaign
