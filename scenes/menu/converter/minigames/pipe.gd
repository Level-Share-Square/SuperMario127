...
func start_entrance_animation(character: Character, is_gp: bool = false) -> void:
	...
	if not is_gp:
		...
		# warning-ignore: return_value_discarded
		tween.interpolate_callback(character.sprite, slide_length + entering_pipe_length/1.2, "hide")
		# warning-ignore: return_value_discarded
		...
		# warning-ignore: return_value_discarded
		tween.interpolate_callback(character.sprite, entering_pipe_fast_length/1.1, "hide")
		# warning-ignore: return_value_discarded
