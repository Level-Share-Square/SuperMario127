...
func _ready():
	...
	max_coin_amount = Singleton.CurrentLevelData.level_data.vars.max_red_coins
	var coin_amount = Singleton.CurrentLevelData.level_data.vars.red_coins_collected[0]
