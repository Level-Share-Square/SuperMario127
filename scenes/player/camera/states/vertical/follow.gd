...
const FULL_MARGIN: float = 96.0

const SLOW_FOLLOW_SPEED: float = 3.0
const FOLLOW_SPEED: float = 6.0
const LERP_SLOWER_SPEED: float = 6.0
const LERP_FASTER_SPEED: float = 6.0

const SPEED_THRESHOLD: float = 120.0
const MAX_SPEED: float = 500.0
const MAX_LEAD_DISTANCE: float = 224.0
