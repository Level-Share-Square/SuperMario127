...
const GREEN_BRICK = 9
const GREEN_BRICK_SLOPE_RIGHT = 11
const GREEN_BRICK_SLOPE_LEFT = 10

const RED_BRICK = 12
const RED_BRICK_SLOPE_RIGHT = 14
const RED_BRICK_SLOPE_LEFT = 13

const YELLOW_BRICK = 15
const YELLOW_BRICK_SLOPE_RIGHT = 17
const YELLOW_BRICK_SLOPE_LEFT = 16
