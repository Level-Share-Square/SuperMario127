...
static func get_new_area_code(header: AreaHeader, old_area: AreaDataOld) -> AreaData:
	...
	var layers: Dictionary = {
		3: LayerData.new(LayerMetadata.new(0, Vector2.ZERO, false, BACKGROUND_TINT, -2, false, "Very Back"), TileData.new()),
		0: LayerData.new(LayerMetadata.new(0, Vector2.ZERO, false, BACKGROUND_TINT, -1, false, "Background"), TileData.new()),
		1: LayerData.new(LayerMetadata.new(0, Vector2.ZERO, false, Color.white, 0, true, "Ground"), TileData.new()),
		2: LayerData.new(LayerMetadata.new(0, Vector2.ZERO, false, Color.white, 1, false, "Foreground"), TileData.new()),
	}
