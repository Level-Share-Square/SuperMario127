...
var _completed_missions: PoolStringArray = [] # element is the mission uuid
...
func _init(s_level_id: String, s_level_folder: String, s_collectible_data: CollectibleData) -> void:
	level_id = s_level_id
...
func load_save_from_dictionary(save_dictionary: Dictionary):
	...
	if save_dictionary["VERSION"] == VERSION:
		...
		load_save_0_1_0(convert_save_to_0_1_0(save_dictionary, collectible_data))
...
func get_total_mission_count() -> int:
	return collectible_data.mission_data.size()
...
func get_total_star_coin_count() -> int:
	return collectible_data.star_coin_data.size()
...
func convert_save_to_0_1_0(save_dictionary: Dictionary, collectible_data: CollectibleData) -> Dictionary:
